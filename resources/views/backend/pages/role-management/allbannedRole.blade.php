...
<div class="row">
    <div class="col-12">
        <h4 class="m-t-0 header-title v-payment">All Banned Role </h4>
        <div class="card-box">
            <div class="mb-3">
                <div class="row">
            ...
            <table id="demo-foo-filtering" class="table text-center table-bordered toggle-circle m-b-0" data-page-size="7">
                ...
                <tbody>
                    @forelse ($banneRoledData as $data)
                    <tr>
                      ...
                      <td>
                        @if ($data->active == 0)
                          <a class="btn btn-success" href="{{ route('banned.active', $data->id) }}">Active</a>
                        @endif
