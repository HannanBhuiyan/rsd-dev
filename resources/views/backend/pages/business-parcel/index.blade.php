                            ...
                            <span class="ml-3">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a class="dropdown-item" href="{{ route('business.parcel.view', $parcel->id) }}">View</a>
                                      @if ($parcel->status == 'pending' || $parcel->status == 'delivery' || $parcel->status == 'calcel')
