...
<div class="row">
    <div class="col-12">
        <h4 class="m-t-0 header-title v-payment">Business View</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="{{ route('allBusinessParcelView') }}">All Parcel</a></li>
                ...
                <tr>
                    ...
                    <td>
                        @if ($data->status == 'pending')
                            <a class="statusCommonlinkButton picked" href="{{ route('personal.parcel.picked', $data->id) }}">Picked</a>
                        ...
                        @elseif ($data->status == 'picked')
                            <a class="statusCommonlinkButton delivery " href="{{ route('personal.parcel.deliver', $data->id) }}">Delivery</a>
                            <a class="statusCommonlinkButton cancel " href="{{ route('personal.parcel.cancel', $data->id) }}">Cancel</a>
