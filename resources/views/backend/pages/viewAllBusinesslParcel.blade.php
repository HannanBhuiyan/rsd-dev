...
<div class="row">
    <div class="col-12">
        <h4 class="m-t-0 header-title v-payment">All Business Parcel</h4>
        <div class="card-box">
            <div class="mb-3">
                <div class="row">
            ...
            <table id="demo-foo-filtering" class="table text-center table-bordered toggle-circle m-b-0" data-page-size="7">
                ...
                <tbody>
                    @forelse ($businessParcelData as $parcel)
                    <tr>
                            ...
                            <span class="ml-3">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a class="dropdown-item" href="{{ route('adminSingleBusinessParcelView', $parcel->id) }}">View</a>
